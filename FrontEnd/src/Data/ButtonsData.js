var ButtonData = [
  {
    _id: "ButtonJsByHMKCodeWebNumber01",
  ...
  {
    _id: "ButtonJsByHMKCodeWebNumber02",
    buttonCategory: "Toggle Switch",
    ReactTailwindCode: `
<label className="relative inline-flex items-center cursor-pointer">
  ...
  <div className="group peer ring-0 bg-rose-400 rounded-full outline-none duration-300 after:duration-300 w-24 h-12 shadow-md peer-checked:bg-emerald-500 peer-focus:outline-none after:content-[''] after:rounded-full after:absolute after:bg-gray-50 after:outline-none after:h-10 after:w-10 after:top-1 after:left-1 after:flex after:justify-center after:items-center peer-checked:after:translate-x-12 peer-hover:after:scale-95">
    ...
    <svg className="absolute top-1 left-12 stroke-gray-900 w-10 h-10" height="100" viewBox="0 0 100 100" width="100">
    ...
    <svg className="absolute top-1 left-1 stroke-gray-900 w-10 h-10" height="100" viewBox="0 0 100 100" width="100">
...
`,
  ...
  {
    _id: "ButtonJsByHMKCodeWebNumber03",
    buttonCategory: "Go Ahead",
    ...
    >
      ...
      <span className="relative z-10 block px-6 py-3 rounded-xl bg-gray-950">
        <div className="relative z-10 flex items-center space-x-2">
          <span className="transition-all text-nowrap duration-500 group-hover:translate-x-1"
...
>
  ...
  {
    _id: "ButtonJsByHMKCodeWebNumber09",

    buttonCategory: "ToolTip On Hover",
  ...
  {
    _id: "ButtonJsByHMKCodeWebNumber10",
    buttonCategory: "Hover Explore",
    ReactTailwindCode: `<button
  type="submit"
  className="flex justify-center gap-2 items-center mx-auto shadow-xl text-lg bg-gray-500 backdrop-blur-md lg:font-semibold isolation-auto border-gray-50 before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-left-full before:hover:left-0 before:rounded-full before:bg-emerald-500 hover:text-gray-50 before:-z-10 before:aspect-square before:hover:scale-150 before:hover:duration-700 relative z-10 px-4 py-2 overflow-hidden border-2 rounded-full group"
>
  Explore
  <svg
...
`,
  ...
  {
    _id: "ButtonJsByHMKCodeWebNumber11",
    buttonCategory: "Hover ToolTip",
    ReactTailwindCode: `
      <div
  className="group relative text-nowrap flex justify-center items-center text-zinc-600 text-sm font-bold"
>
  <div
  ...
  `,
    NumberOfViews: "0",
    NumbersOfCopyCode: "0",
    createdOn: "2025-08-08T10:20:00.000+00:00",
  },
  {
    _id: "ButtonJsByHMKCodeWebNumber13",
    buttonCategory: "Neumorphism",
    ReactTailwindCode: `
      <button className="text-[#090909] px-7 py-3 text-lg rounded-md bg-[#e8e8e8] border border-[#e8e8e8] shadow-[6px_6px_12px_#c5c5c5,-6px_-6px_12px_#ffffff] transition-all duration-300 active:text-[#666] active:shadow-[inset_4px_4px_12px_#c5c5c5,inset_-4px_-4px_12px_#ffffff]">
      Click me
    </button>
    `,
    NumberOfViews: "640",
  ...
  },
  {
    ...
    ReactTailwindCode: `
      <button
      className="items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-transform duration-200 ring-offset-background t focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 group relative animate-rainbow cursor-pointer border-0 bg-[linear-gradient(#fff,#fff),linear-gradient(#fff_50%,rgba(255,255,255,0.6)_80%,rgba(0,0,0,0)),linear-gradient(90deg,hsl(0,100%,63%),hsl(90,100%,63%),hsl(210,100%,63%),hsl(195,100%,63%),hsl(270,100%,63%))] bg-[length:200%] text-foreground [background-clip:padding-box,border-box,border-box] [background-origin:border-box] [border:calc(0.08*1rem)_solid_transparent] before:absolute before:bottom-[-20%] before:left-1/2 before:z-[0] before:h-[20%] before:w-[60%] before:-translate-x-1/2 before:animate-rainbow before:bg-[linear-gradient(90deg,hsl(0,100%,63%),hsl(90,100%,63%),hsl(210,100%,63%),hsl(195,100%,63%),hsl(270,100%,63%))] before:[filter:blur(calc(0.8*1rem))] dark:bg-[linear-gradient(#121213,#121213),linear-gradient(#121213_50%,rgba(18,18,19,0.6)_80%,rgba(18,18,19,0)),linear-gradient(90deg,hsl(0,100%,63%),hsl(90,100%,63%),hsl(210,100%,63%),hsl(195,100%,63%),hsl(270,100%,63%))] hover:scale-105 active:scale-95 h-10 px-4 py-2 inline-flex"
    >
  ...
  },
  {
    ...
    ReactTailwindCode: `<button className="cursor-pointer transition-all bg-blue-500 text-white px-6 py-2 rounded-lg
border-blue-600
...
active:border-b-[2px] active:brightness-90 active:translate-y-[2px]">
  ...
  {
    _id: "ButtonJsByHMKCodeWebNumber18",
    buttonCategory: "Glow Gradient",
    ReactTailwindCode: `
    <button
    ...
    >
      ...
      <span className="flex items-center justify-center gap-1 relative z-[1] dark:bg-neutral-950/90 bg-neutral-50/90 rounded-full py-2 px-4 pl-2 w-full">
        ...
        <span className="bg-gradient-to-b text-nowrap ml-1.5 dark:from-white dark:to-white/50 from-neutral-950 to-neutral-950/50 bg-clip-text text-xs text-transparent group-hover:scale-105 transition transform-gpu">
          Star hassaanhaider88 on Github
        </span>
      </span>
    </button>
  `,
...
>
  ...
  <span
    className="origin-left text-nowrap inline-flex duration-100 group-hover:duration-300 group-hover:delay-500 opacity-0 group-hover:opacity-100 border-l-2 px-1 transform scale-x-0 group-hover:scale-x-100 transition-all"
    >Hassaan Haider</span
  >
</button>
`,
...
>
  <span className="text-lg">ButtonJs</span>
  <div
...
`,
  ...
  },
  {
    ...
    ReactTailwindCode: `<button className="cursor-pointer font-semibold overflow-hidden relative z-100 border border-green-500 group px-8 py-2">
  ...
  },
  {
    ...
    ReactTailwindCode: `<button
  className="relative flex items-center gap-1 bg-neutral-600 px-9 py-4 border-4 border-black text-base  rounded-xl font-semibold text-white cursor-pointer overflow-hidden transition-all duration-600 ease-custom hover:text-black hover:rounded-3xl group hover:transition-all hover:duration-700"
>
  <svg
    viewBox="0 0 24 24"
  ...
  <span
    className="relative z-[1] transition-all text-nowrap duration-700 ease-custom -translate-x-3 group-hover:translate-x-3"
    >Modern Button</span
  >
  <span
...
`,
  ...
  },
  {
    ...
    ReactTailwindCode: `<button
  className="bg-[linear-gradient(#e9e9e9,#e9e9e9_50%,#fff)] group w-50 h-16 inline-flex transition-all duration-300 overflow-visible p-1 rounded-full"
>
  <div className="w-half h-full bg-[linear-gradient(to_top,#ececec,#fff)] overflow-hidden shadow-[0_0_1px_rgba(0,0,0,0.07),0_0_1px_rgba(0,0,0,0.05),0_3px_3px_rgba(0,0,0,0.25),0_1px_3px_rgba(0,0,0,0.12)] p-1 rounded-full hover:shadow-none duration-300">
    <div className="w-full h-full text-xl gap-x-0.5 gap-y-0.5 justify-center text-[#101010] bg-[linear-gradient(#f4f4f4,#fefefe)] group-hover:bg-[linear-gradient(#e2e2e2,#fefefe)] duration-200 items-center text-[18px] font-medium gap-4 inline-flex overflow-hidden px-4 py-2 rounded-full group-hover:text-blue-600">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 64 64"
        height="32px"
...
`,
  ...
  },
  {
    ...
    ReactTailwindCode: `<button
  className="bg-[#ADD8E6] px-6 py-3 text-white relative overflow-hidden z-30 group hover:bg-sky-800 transition-all duration-500 rounded tracking-wider font-semibold"
>
  Hover Me

  <svg
    className="absolute inset-0 left-0 top-0 fill-sky-300 -z-30 opacity-0 group-hover:opacity-100 group-hover:duration-300 group-hover:transition-all groupActive:fill-sky-950"
    preserveAspectRatio="xMidYMid meet"
...
>
  ...
  <span className="relative z-10 flex items-center gap-2">
    <span className="tracking-wider text-nowrap">Click me!</span>
    <svg
      viewBox="0 0 24 24"
      stroke="currentColor"
      fill="none"
...
},
  {
    ...
    ReactTailwindCode: `<div className="flex items-center justify-center">
      {/* Hidden checkbox */}
      ...
      <label
        htmlFor="toggle"
        className="relative w-[120px] h-[60px] rounded-[30px] cursor-pointer 
        bg-gradient-to-br from-gray-300/80 via-gray-500/80 to-gray-400/80 
        shadow-[inset_0_2px_4px_rgba(255,255,255,0.5),inset_0_-2px_4px_rgba(0,0,0,0.2),0_4px_8px_rgba(0,0,0,0.3)]
        transition-all duration-500 ease-in-out peer-checked:bg-green-600"
      >
        {/* Inner track */}
        <div
          className="absolute top-[5px] left-[5px] right-[5px] bottom-[5px] rounded-[30px] 
          bg-gray-700/70 shadow-[inset_0_2px_4px_rgba(255,255,255,0.1),inset_0_-2px_4px_rgba(0,0,0,0.5)]
          transition-all duration-500 ease-in-out peer-checked:bg-green-500 
          peer-checked:shadow-[0_0_10px_rgba(76,175,80,0.5)]"
        ></div>

        {/* Knob */}
        <div
          className="absolute top-[5px] left-[5px] w-[50px] h-[50px] rounded-full 
          bg-gradient-radial from-white/40 via-gray-300/60 to-gray-400/90 
          shadow-[0_2px_4px_rgba(0,0,0,0.3),inset_0_1px_2px_rgba(255,255,255,0.5)]
          transition-all duration-500 ease-[cubic-bezier(0.175,0.885,0.32,1.275)] 
          peer-checked:translate-x-[60px]"
        >
          {/* Screw */}
          <div className="absolute top-1/2 left-1/2 w-[10px] h-[10px] rounded-full bg-gray-800 transform -translate-x-1/2 -translate-y-1/2 shadow-[inset_0_1px_2px_rgba(0,0,0,0.5),0_0_0_2px_rgba(0,0,0,0.2)]"></div>
        </div>
      </label>
    </div>`,
    NumberOfViews: "720",
...
`,
  ...
  <div className="w-[10px] h-[10px] blur-[5px] bg-[rgb(30,41,59)] delay-[0.2s] duration-[0.4s] hover:bg-transparent hover:delay-0 hover:duration-0 group-focus:bg-transparent"></div>
...
`,
  ...
  },  
  {
    ...
    ReactTailwindCode: ` <div className="flex items-center">
      {/* Avatar 1 */}
      <div className="relative w-[60px] h-[60px] rounded-full border-4 border-white bg-gradient-to-br from-indigo-600 to-purple-600 flex items-center justify-center text-white font-bold text-lg cursor-pointer ml-0 hover:scale-125 hover:z-10 transition-transform duration-300">
        <span>HMK</span>
        <div className="absolute bottom-[110%] left-1/2 -translate-x-1/2 scale-75 bg-white text-gray-900 px-3 py-1.5 rounded-lg text-sm whitespace-nowrap opacity-0 pointer-events-none shadow-lg transition-all duration-300 group-hover:opacity-100 group-hover:scale-100">
         Hassaan
        </div>
      </div>

      {/* Avatar 2 */}
      <div className="relative w-[60px] h-[60px] rounded-full border-4 border-white bg-gradient-to-br from-emerald-500 to-cyan-500 flex items-center justify-center text-white font-bold text-lg cursor-pointer -ml-5 hover:scale-125 hover:z-10 transition-transform duration-300">
        <span>S88</span>
        <div className="absolute bottom-[110%] left-1/2 -translate-x-1/2 scale-75 bg-white text-gray-900 px-3 py-1.5 rounded-lg text-sm whitespace-nowrap opacity-0 pointer-events-none shadow-lg transition-all duration-300 group-hover:opacity-100 group-hover:scale-100">
          Sannay
        </div>
      ...
      {/* Avatar 3 */}
      <div className="relative w-[60px] h-[60px] rounded-full border-4 border-white bg-gradient-to-br from-amber-500 to-red-500 flex items-center justify-center text-white font-bold text-lg cursor-pointer -ml-5 hover:scale-125 hover:z-10 transition-transform duration-300">
        <span>CW</span>
        <div className="absolute bottom-[110%] left-1/2 -translate-x-1/2 scale-75 bg-white text-gray-900 px-3 py-1.5 rounded-lg text-sm whitespace-nowrap opacity-0 pointer-events-none shadow-lg transition-all duration-300 group-hover:opacity-100 group-hover:scale-100">
        CodeWeb
        </div>
      ...
      {/* Avatar 4 */}
      <div className="relative w-[60px] h-[60px] rounded-full border-4 border-white bg-gradient-to-br from-pink-500 to-violet-500 flex items-center justify-center text-white font-bold text-lg cursor-pointer -ml-5 hover:scale-125 hover:z-10 transition-transform duration-300">
        <span>KM</span>
        <div className="absolute bottom-[110%] left-1/2 -translate-x-1/2 scale-75 bg-white text-gray-900 px-3 py-1.5 rounded-lg text-sm whitespace-nowrap opacity-0 pointer-events-none shadow-lg transition-all duration-300 group-hover:opacity-100 group-hover:scale-100">
          Kunal Mehta
        </div>
...

{
  ...
  <button className="relative font-bold text-white rounded-full cursor-pointer w-[95.02px] h-[42.66px] bg-[#3653f8] flex justify-center items-center overflow-hidden group">
      ...
      <span className="flex overflow-hidden group-hover:absolute">
        <span className="transition-transform duration-200 group-hover:translate-y-[1.2em]">B</span>
        <span className="transition-transform duration-300 group-hover:translate-y-[1.2em]">u</span>
        <span className="transition-transform duration-400 group-hover:translate-y-[1.2em]">t</span>
        <span className="transition-transform duration-500 group-hover:translate-y-[1.2em]">t</span>
        <span className="transition-transform duration-600 group-hover:translate-y-[1.2em]">o</span>
        <span className="transition-transform duration-700 group-hover:translate-y-[1.2em]">n</span>
      </span>

      {/* Second set of letters */}
      <span className="flex absolute overflow-hidden">
        <span className="transition-transform duration-200 -translate-y-[1.2em] group-hover:translate-y-0">B</span>
        <span className="transition-transform duration-300 -translate-y-[1.2em] group-hover:translate-y-0">u</span>
        <span className="transition-transform duration-400 -translate-y-[1.2em] group-hover:translate-y-0">t</span>
        <span className="transition-transform duration-500 -translate-y-[1.2em] group-hover:translate-y-0">t</span>
        <span className="transition-transform duration-600 -translate-y-[1.2em] group-hover:translate-y-0">o</span>
